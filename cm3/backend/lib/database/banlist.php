...
class cm_banlist_db extends cm_Table{
	...
	protected function setupTableDefinitions() : void
	{
      ...
      'normalized_real_name'  => new cm_Column('VARCHAR', '500', null,customPostfix: 'GENERATED as (UPPER(REGEXP_REPLACE(`real_name`,\'[^A-Za-z0-9]+\',\'\'))) STORED'),
			'normalized_fandom_name'   => new cm_Column('VARCHAR', '255', null,customPostfix: 'GENERATED as (UPPER(REGEXP_REPLACE(`fandom_name`,\'[^A-Za-z0-9]+\',\'\'))) STORED'),
			'normalized_email_address' => new cm_Column('VARCHAR', '255', null,customPostfix: 'GENERATED as (UPPER(REGEXP_REPLACE(`email_address`,\'[^A-Za-z0-9]+\',\'\'))) STORED'),
			'normalized_phone_number'  => new cm_Column('VARCHAR', '255', null,customPostfix: 'GENERATED as (UPPER(REGEXP_REPLACE(`phone_number`,\'[^A-Za-z0-9]+\',\'\'))) STORED'),
	...
	function getWhereTerm($paramValue, $matchOn)
	{
