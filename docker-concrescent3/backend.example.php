...
// This needs to match the set timezone of the MySQL Database.
// Check docker-compose for configured timezone when running in a docker-compose setup.
...
return array(
    ...
    'database' => array(
        ...
        // By default, these values match with the docker-compose MySQL server.
        'host' => 'mysql',
        'username' => 'concrescent',
        'password' => 'concrescent',
        // Name of the MySQL database to use for this application.
        'database' => 'concrescent',
        'prefix' => 'cm3_',
    ...
    'environment' => array(
        ...
        // No trailing slash!
        // Should not need to be changed when running in a docker-compose setup,
        // it will always be mounted in the web root.
        'base_path' => '',
